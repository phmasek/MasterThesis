...
\node[draw,ellipse,dashed] at (v1int) () {\scriptsize Interpretation};
...
\path[draw,-latex',thick] (v1per) -- (v1int);
\path[draw,-latex',thick] (v2per.east) -| ++(0.7,1.2) -- ++(.9,0);
\path[draw,-latex',thick] (v1per.east) ++(0,0.9) -| ++(0.7,1.35) -- ++(1.7,0);
\path[draw,-latex',thick] (v1int) -- (v1act);
\path[draw,-latex',thick] (v3int.east) ++(0,1.2) -| ++(0.5,-.4) -- ++(1.3,0);


\path[draw,-latex',thick] (v2per.north) ++(-.7,0) |-  ++(-1.6,.4) |-  ++(0,-1.5) |- ++(.395,0) ;
...
\path[draw,-latex',thick] (camera.east) ++(0,.5) -- (v1per.west);
\end{scope}
...
\node[box,fit={ (0,0) (5.635,.8)},fill=orange] (dockerengine) [right=1.6 of hypervisor] {\scriptsize Docker Engine};
