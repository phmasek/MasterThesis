...
\node[box,fill=blues1] (app1) {\footnotesize App 1};
\node[box,fill=blues1] (app1lib) [below=0.1 of app1] {\footnotesize Bins/Libs};
\node[box,fit={ (0,0) (1.8,2)},fill=blues1] (app1os) [below=0.1 of app1lib] {\footnotesize Guest OS};


\node[box,fill=blues2] (app2) [right=0.1 of app1] {\footnotesize App 2};
\node[box,fill=blues2] (app2lib) [below=0.1 of app2] {\footnotesize Bins/Libs};
\node[box,fit={ (0,0) (1.8,2)},fill=blues2] (app2os) [below=0.1 of app2lib] {\footnotesize Guest OS};

\node[box,fill=blues3] (app3) [right=0.1 of app2] {\footnotesize App 3};
\node[box,fill=blues3] (app3lib) [below=0.1 of app3] {\footnotesize Bins/Libs};
\node[box,fit={ (0,0) (1.8,2)},fill=blues3] (app3os) [below=0.1 of app3lib] {\footnotesize Guest OS};

\node[box,fit={ (0,0) (5.635,.8)},fill=black!20] (hypervisor) [below=0.1 of app2os] {\footnotesize Hypervisor};
\node[box,fit={ (0,0) (5.635,.8)},fill=black!30] (vmhost) [below=0.1 of hypervisor] {\footnotesize Host Operating System};
\node[box,fit={ (0,0) (5.635,1.6)},fill=black!40] (vmhw) [below=0.1 of vmhost] {\footnotesize Computer Hardware};


\node[box,fit={ (0,0) (5.635,.8)},fill=orange] (dockerengine) [right=1.6 of hypervisor] {\footnotesize Docker Engine};
\node[box,fit={ (0,0) (5.635,.8)},fill=black!30] (vmhost) [below=0.1 of dockerengine] {\footnotesize Host Operating System};
\node[box,fit={ (0,0) (5.635,1.6)},fill=black!40] (vmhw) [below=0.1 of vmhost] {\footnotesize Computer Hardware};

\node[box,fill=blues2] (dockerapp2lib) [above=0.1 of dockerengine] {\footnotesize Bins/Libs};
\node[box,fill=blues2] (dockerapp2) [above=0.1 of dockerapp2lib] {\footnotesize App 2};

\node[box,fill=blues3] (dockerapp3lib) [right=0.1 of dockerapp2lib] {\footnotesize Bins/Libs};
\node[box,fill=blues3] (dockerapp3) [above=0.1 of dockerapp3lib] {\footnotesize App 3};

\node[box,fill=blues1] (dockerapp1lib) [left=0.1 of dockerapp2lib] {\footnotesize Bins/Libs};
\node[box,fill=blues1] (dockerapp1) [above=0.1 of dockerapp1lib] {\footnotesize App 1};



\node[box,fit={(0,0) (5.635,3)}] (dockerheading) [above=2.1 of dockerapp2] {\textbf{Docker Architecture}};
\node[box,fit={(0,0) (5.635,3)}] (vmheading) [above=0 of app2] {\textbf{Virtual Machine Architecture}};
\node[box,fit={(0,0) (5.635,1)}] (vmheading) [below=0 of vmhw] {};



\end{tikzpicture}
\caption{Architectural difference between Virtual Machines and Docker}
\end{figure}
