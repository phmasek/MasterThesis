...
The aim of the experiment is to systematically evaluate the scheduling precision of the experimental units running in different execution environments with respect to the deployment context. The goals of the experiment are described in table~\ref{table:exp-goals}, where the experimental units, execution environment and system load is described further in this section.  
...
\todo{Reference to this paper regarding what an execution enviroment is: https://www.cs.york.ac.uk/rts/books/RTSbookFourthEdition/executionEnvironment.pdf}
