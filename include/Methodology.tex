...
To address both research questions and to ensure full coverage, the experiment results is analysed through an analysis of variance (ANOVA) to understand the impact the different treatments have on the dependent variable. As this research has a very large sample size the data gathered will provide high significance. To understand the impact of the treatments further correlation analysis is made between the subjects and treatments.\\
